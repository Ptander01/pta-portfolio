    ...
    features: [
      {
        ...
        description:
          "Transitive spatial clustering, scoped by company, producing human-readable source-agnostic identifiers — {COMPANY}-{CAMPUS} in the internal build, {country}-{state}-{city}-{nnn} in the public one. The 250 m tolerance was not assumed: both a 250 m and a 1,000 m version were built in full and scored against ground truth for false merges in dense markets against orphan splits on sprawling rural sites, and the tighter one won.",
      },
      {
